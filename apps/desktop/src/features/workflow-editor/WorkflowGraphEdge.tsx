    ...
    <>
      ...
      {label.length > 0 ? (
        <EdgeLabelRenderer>
          <div
            className={cx(
              "workflow-editor-edge-label absolute max-w-[180px] truncate rounded-full border bg-[color-mix(in_srgb,var(--color-island-0)_94%,transparent)] px-[var(--space-2)] py-[2px] text-xs font-semibold text-[var(--color-on-island)] shadow-[var(--shadow-island-1)] backdrop-blur-[18px]",
