...
- Use `{{.BuilderRunCommand}} task` to interact with tickets (add new, update current, leave comments etc.). Example: `{{.BuilderRunCommand}} task show {{.TaskShortId}}` will show the overall ticket context.
