...
func visibleDeveloperChatEntry(msg llm.Message) (ChatEntry, bool) {
	...
	case llm.MessageTypeGoal:
		return ChatEntry{Visibility: transcript.EntryVisibilityAll, Role: string(transcript.EntryRoleDeveloperContext), Text: msg.Content, OngoingText: msg.CompactContent, MessageType: msg.MessageType, CompactLabel: compactLabelForMessage(msg)}, true
