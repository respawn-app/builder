...
var gatewayUnaryHandlerEntries = map[string]gatewayUnaryHandler{
	...
	protocol.MethodProjectDeletePreview:          gatewayClientCall[client.ProjectViewClient, serverapi.ProjectDeletePreviewRequest, serverapi.ProjectDeletePreviewResponse](gatewayProjectViewClient, client.ProjectViewClient.PreviewProjectDelete),
