...
func providerContracts() []ProviderContract {
	return []ProviderContract{
		...
		},
		{
			...
			ModelContracts: []ModelCapabilityContract{
				{Model: "gpt-5", SupportsReasoningEffort: true, SupportsVerbosity: true, SupportsVisionInputs: true},
				{Model: "gpt-5.4", SupportsReasoningEffort: true, SupportsVerbosity: true, SupportsVisionInputs: true},
				{Model: "gpt-5.3-codex", ContextWindowTokens: 400_000, SupportsReasoningEffort: true, SupportsVerbosity: true, SupportsVisionInputs: true},
				{Model: "gpt-4.1", SupportsReasoningEffort: true, SupportsVisionInputs: true},
				{Model: "gpt-4o", SupportsReasoningEffort: true, SupportsVisionInputs: true},
				{Model: "gpt-4o-mini", SupportsReasoningEffort: true, SupportsVisionInputs: true},
				{Model: "o1", SupportsReasoningEffort: true, SupportsVisionInputs: true},
				{Model: "o3", SupportsReasoningEffort: true, SupportsVisionInputs: true},
				{Model: "o3-mini", SupportsReasoningEffort: true, SupportsVisionInputs: true},
				{Model: "o4", SupportsReasoningEffort: true, SupportsVisionInputs: true},
				{Model: "o4-mini", SupportsReasoningEffort: true, SupportsVisionInputs: true},
			},
		},
	}
}
