	...
	return []ProviderContract{
		...
		},
		{
			...
			ModelContracts: []ModelCapabilityContract{
				...
				{Model: "o1", SupportsReasoningEffort: true, SupportsReasoningSummary: true, SupportsVisionInputs: true},
				{Model: "o3", SupportsReasoningEffort: true, SupportsReasoningSummary: true, SupportsVisionInputs: true},
				{Model: "o3-mini", SupportsReasoningEffort: true, SupportsReasoningSummary: true, SupportsVisionInputs: true},
				{Model: "o4", SupportsReasoningEffort: true, SupportsReasoningSummary: true, SupportsVisionInputs: true},
				{Model: "o4-mini", SupportsReasoningEffort: true, SupportsReasoningSummary: true, SupportsVisionInputs: true},
			},
		},
	}
}
