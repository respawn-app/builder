...
func newSettingsRegistry() settingsRegistry {
	settings := []registrySetting{
		...
		newStringSetting("thinking_level", defaultThinkingLevel,
			...
			nil,
			settingDocOptions{}),
		newStringSetting("model_verbosity", ModelVerbosity(""),
		...
		newBoolSetting("priority_request_mode", false,
			...
			"",
			settingDocOptions{}),
		newStringSetting("web_search", "off",
		...
		newStringSetting("reviewer.thinking_level", defaultReviewerThinking,
		...
		newIntSetting("reviewer.timeout_seconds", defaultReviewerTimeoutSec,
			...
			nil,
			settingDocOptions{}),
		newIntSetting("reviewer.max_suggestions", defaultReviewerSuggestions,
			func(state *settingsState, value int) { state.Settings.Reviewer.MaxSuggestions = value },
			func(state settingsState) int { return state.Settings.Reviewer.MaxSuggestions },
