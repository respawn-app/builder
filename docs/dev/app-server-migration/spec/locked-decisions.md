...
- The default WebSocket adapter uses `github.com/lxzan/gws` behind `shared/rpcwire`. Frontend/server code stays bound to the Builder-owned transport boundary instead of a WebSocket-library-specific API.
