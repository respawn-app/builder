...
| `debug` | bool | `false` | `BUILDER_DEBUG` |  | Enables global developer-oriented strictness. Builder may hard-fail invariants that production mode would otherwise recover from. |
