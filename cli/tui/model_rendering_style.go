...
func (m Model) roleSymbol(role string) string {
	...
	case "error", "warning", roleCacheWarning, roleDeveloperFeedback, roleInterruption:
		return renderRoleSymbol(prefix, roleSymbolStyle(role, p))
...
func roleSymbolStyle(role string, p palette) roleSymbolColorStyle {
	...
	case "tool_question_error", "error", roleCacheWarning, roleDeveloperFeedback, roleInterruption:
